...
class ResetPasswordController extends AbstractController
{
     ...
     */
    #[Route('/email-envoye', name: 'app_check_email', methods: ['GET'])]
     ...
     */
    #[Route('/reinitialiser/{token}', name: 'app_reset_password', methods: ['GET', 'POST'])]
    public function reset(Request $request, UserPasswordHasherInterface $passwordHasher, TranslatorInterface $translator, ?string $token = null): Response
    {
        ...
        if (null === $token) {
            throw $this->createNotFoundException('Aucun jeton de réinitialisation valide n’a été trouvé.');
        }
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, TranslatorInterface $translator): RedirectResponse
    {
        ...
        try {
            $resetToken = $this->passwordResetLinkSender->send($user);
        } catch (ResetPasswordExceptionInterface $e) {
            $this->addFlash('reset_password_error', sprintf(
                '%s - %s',
            ...
            $this->addFlash('reset_password_error', 'Le lien de réinitialisation n’a pas pu être préparé pour le moment.');
